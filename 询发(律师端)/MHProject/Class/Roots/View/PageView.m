...
{
    DEF_DEBUG(@"scrollView-frame:%f",self.scrollView.contentOffset.x);
...
{
    DEF_DEBUG(@"%zd  & %f",page.currentPage,self.bounds.size.width);
    //获取当前页面的宽度
...
{
    DEF_DEBUG(@"点击了第%ld页",self.pageControl.currentPage);
