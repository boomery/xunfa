...
@interface PengdingViewCell : UITableViewCell
...
@property(nonatomic,strong)UILabel *pendingStatusLab;//内容

-(void)loaPendingCellWithDict:(NSDictionary *)dict;


-(void)loaPendingCellWithDict:(NSDictionary *)dict WithIndexpath:(NSIndexPath *)indexpath;
