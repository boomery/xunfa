...
{
    NSString *passWordRegex = @"^[a-zA-Z0-9]{8,100}+$";
    NSPredicate *passWordPredicate = [NSPredicate predicateWithFormat:@"SELF MATCHES %@",passWordRegex];
    return [passWordPredicate evaluateWithObject:passWord];
}
...
+ (BOOL)checkInputMobile:(NSString *)_moblie
{
    ...
    NSPredicate *regextestcu = [NSPredicate predicateWithFormat:@"SELF MATCHES %@", CU];
    NSPredicate *regextestct = [NSPredicate predicateWithFormat:@"SELF MATCHES %@", CT];
    BOOL res1 = [regextestmobile evaluateWithObject:_moblie];
    BOOL res2 = [regextestcm evaluateWithObject:_moblie];
    BOOL res3 = [regextestcu evaluateWithObject:_moblie];
    BOOL res4 = [regextestct evaluateWithObject:_moblie];
